...
export default function Icon(props) {
  const {dark, onClick, onMouseDown, onMouseUp, text} = props;
    ...
    <svg viewBox='0 0 512 512'>
      <g onClick={onClick} onMouseDown={onMouseDown} onMouseUp={onMouseUp}>
        ...
        <g transform='scale(21.33)'>
          ...
          <text x={12} y={13.5} textAnchor='middle' fill={color} stroke={color} strokeWidth={0.15} style={{fontSize: '4px'}}>{text}</text>
        </g>
      </g>
    </svg>
  );
