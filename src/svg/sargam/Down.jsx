    ...
    <svg viewBox='0 0 512 512'>
      <g onClick={onClick} onMouseDown={onMouseDown} onMouseUp={onMouseUp}>
        ...
        <g transform='scale(21.33)'>
          ...
          <path d='m8 12 4 4 4-4' fill='none' stroke={color} strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round' />
          <path d='M12 16V8' stroke={color} strokeWidth='1.5' strokeMiterlimit='10' strokeLinecap='round' />
        </g>
      </g>
    </svg>
  );
